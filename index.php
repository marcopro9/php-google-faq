...
<html lang="en" dir="ltr">
  ...
  <body>
    <header class="clearfix">
      <a href="#">
        <img class="logo" src="img/google_logo.png" alt="Google logo">
        <span class="section-name">Privacy e termini</span>
      </a>
      ...
      <a href="#" class="mail"><img class="profile-img" src="img/mini_me.png" alt="">mail.com</a>
    </header>
    <div class="container">
      <ul class="faq-list">
        <?php foreach ($array_questions as $faq => $domanda_risposta) {?>
        <li>
          <h2><?php echo $domanda_risposta['domanda'] ?></h2>
          <p><?php echo $domanda_risposta['risposta'] ?></p>
        </li>
      <?php } ?>
      </ul>
    </div>
